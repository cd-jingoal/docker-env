...
APPDIR="$BASEDIR/appmarket"
TARGETDIR="$BASEDIR/module"
APPTARBALL="$BASEDIR/appmarket*.war"
...
if [ -e $TARGETDIR/WEB-INF/classes/com/jingoal/web/appmarket/ ]; then
  rm -rf $TARGETDIR/WEB-INF/classes/com/jingoal/web/appmarket/
fi

if [ -e $APPDIR/WEB-INF/classes/com/jingoal/web/appmarket/ ]; then
  mkdir -p $TARGETDIR/WEB-INF/classes/com/jingoal/web/appmarket/
  cp -rf $APPDIR/WEB-INF/classes/com/jingoal/web/appmarket/*  $TARGETDIR/WEB-INF/classes/com/jingoal/web/appmarket/
fi

if [ -e $TARGETDIR/WEB-INF/classes/com/jingoal/appmarket/ ]; then
  rm -rf $TARGETDIR/WEB-INF/classes/com/jingoal/appmarket/
fi

if [ -e $APPDIR/WEB-INF/classes/com/jingoal/appmarket/ ]; then
  mkdir -p $TARGETDIR/WEB-INF/classes/com/jingoal/appmarket/
  cp -rf $APPDIR/WEB-INF/classes/com/jingoal/appmarket/*  $TARGETDIR/WEB-INF/classes/com/jingoal/appmarket/
fi

# lib

# page
rm -rf $TARGETDIR/appmarket/
mkdir -p $TARGETDIR/appmarket/
cp -rf $APPDIR/appmarket/*  $TARGETDIR/appmarket/

# i18n properties
rm -rf $TARGETDIR/WEB-INF/classes/appmarket*
cp -rf $APPDIR/WEB-INF/classes/appmarket*  $TARGETDIR/WEB-INF/classes/

if [ -e $APPDIR ]; then
  rm -rf  $APPDIR
fi
echo "move resources to target dir success."

echo "remove appmarket.war"

rm $BASEDIR/appmarket.war

echo "remove war success"
