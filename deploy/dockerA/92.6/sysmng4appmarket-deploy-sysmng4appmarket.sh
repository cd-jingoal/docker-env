...
# page
rm -rf $TARGETDIR/sysmng/
mkdir -p $TARGETDIR/sysmng/
cp -rf $APPDIR/sysmng/*  $TARGETDIR/sysmng/

# i18n properties
rm -rf $TARGETDIR/WEB-INF/classes/sysmng*
cp -rf $APPDIR/WEB-INF/classes/sysmng*  $TARGETDIR/WEB-INF/classes/
...
echo "remove sysmng.war"

rm $BASEDIR/sysmng.war
